...
const SceneRegistryScript := preload("res://scripts/compute/full/gaussian_scene_registry.gd")
const GpuStateCacheScript := preload("res://scripts/compute/full/gaussian_gpu_state_cache.gd")
const RendererScript := preload("res://scripts/compute/full/gaussian_renderer.gd")
